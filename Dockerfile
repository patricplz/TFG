...
RUN php -r "copy('https://getcomposer.org/installer', 'composer-setup.php');" && \
    php -r "if (hash_file('sha384', 'composer-setup.php') === 'e21205b207c3ffce031862d29b8d88e7afad34d0590822b397be03ea1dbdbb4ddcdb08a1', 'composer-setup.php') === 'e21205b207c3ffce031862d29b8d88e7afad34d0590822b397be03ea1dbdbb4ddcdb08a1') { echo 'Installer verified'; } else { echo 'Installer corrupt'; unlink('composer-setup.php'); } echo PHP_EOL;" && \
