...
// Interfaz que define la estructura de los datos del alumno
...
// Interfaz para los datos que se manejan en el formulario
interface FormData {
    cv: File | null;
    ...
    email: string;
    telefono: string;
    [key: string]: string | number | boolean | File | null; // Permite flexibilidad en las claves
}

// Props que se reciben en el componente de perfil
interface CompleteProfileProps {
    alumno: AlumnoData | null;
}

// Ruta de navegación del panel del alumno
...
export default function CompletaPerfil({ alumno }: CompleteProfileProps) {
    ...
    const [cvDisplayName, setCvDisplayName] = useState<string | null>(null); 
    const [fotoPerfilDisplayName, setFotoPerfilDisplayName] = useState<string | null>(null); 

    // Se inicializa el formulario con los datos existentes del alumno, si los hay
    ...
    // Carga las URLs previas del CV y la foto de perfil si están disponibles
    useEffect(() => {
        if (alumno) {
            if (alumno.cv_url) {
    ...
    // Controlador para el cambio del archivo de CV
    ...
    // Controlador para el cambio de la foto de perfil
    ...
    const submit = (e: React.FormEvent) => {
        ...
        post(route('alumno.perfil.guardar'), {
            forceFormData: true, // Envía los datos como FormData para incluir archivos
        });
    };

    const [progress, setProgress] = useState<number>(0);

    // Calcula el progreso del formulario para mostrarlo en una barra visual
    useEffect(() => {
        ...
        if (form) {
            ...
            inputs.forEach((input) => {
                ...
                if (val !== '' || (input as HTMLInputElement).type === 'date') {
                    filledFields++;
                }
            ...
            // Consideramos que se ha subido un CV
            ...
            totalFields++; 
            // También la foto de perfil cuenta
    ...
    // Color de la barra de progreso en función del porcentaje
                        ...
                        <div className="overflow-hidden rounded-lg shadow-xl">
                            ...
                            <div className="p-6">
                                <form onSubmit={submit} className="space-y-6" ref={formRef}>
                                    ...
                                    <div className="rounded-lg border border-black p-4" style={{ backgroundColor: 'oklch(0.28 0.03 232)' }}>
                                        <h2 className="mb-4 flex items-center text-lg font-semibold text-white font-bold">
                                            <svg className="mr-2  text-blue-500 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="rounded-lg border-2 border-dashed border-gray-300 p-4 text-center transition-colors hover:border-blue-400">
                                    ...
                                    <div className="rounded-lg border border-gray-100 p-4" style={{ backgroundColor: 'oklch(0.28 0.03 232)' }}>
                                        <h2 className="mb-4 flex items-center text-lg font-semibold text-white font-bold">
                                            ...
                                            >
                                                ...
                                                <path
                                                    strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222"
                                                />
                                            </svg>
                                    ...
                                    <div className="rounded-lg border border-gray-100 p-4" style={{ backgroundColor: 'oklch(0.28 0.03 232)' }}>
                                        <h2 className="mb-4 mb-2 flex items-center text-lg font-semibold text-white font-bold">
                                    ...
                                    <div className="rounded-lg border border-gray-100 p-4" style={{ backgroundColor: 'oklch(0.28 0.03 232)' }}>
                                        <h2 className="mb-4 flex items-center text-lg font-semibold text-white font-bold">
                                            <svg
                                                className="mr-2  h-5 w-5 text-blue-500" fill="none"   stroke="currentColor" viewBox="0 0 24 24" 
                                                xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    {/* Botón para guardar el perfil con estados de carga y estilo visual atractivo */}
                                    <div className="flex justify-center pt-5">
                                        <button type="submit" disabled={processing} className="focus:ring-opacity-50 transform rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-3 font-bold text-white shadow-md transition-all duration-300 hover:scale-105 hover:from-blue-700 hover:to-indigo-700 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                                            {processing ? (
