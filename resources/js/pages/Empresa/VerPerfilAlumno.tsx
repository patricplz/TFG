        ...
        <>
            <AppLayout breadcrumbs={breadcrumbs}>
                ...
                <div className="w-full m-4 max-w-5xl mx-auto bg-transparent rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-gray-900 to-blue-900 text-white p-6 m-4 rounded-lg">
                        <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                            <div className="relative">
                                {alumno.foto_perfil_path ? (
                                    <img
                                        src={`/storage/${alumno.foto_perfil_path}`} //todo: no sale la foto de perfil
                            ...
                            <div className="mt-4 md:mt-0 md:ml-auto">
                                <button className="bg-green-500 cursor-pointer hover:bg-green-600 text-white font-bold py-2 px-6 rounded-full shadow-md flex items-center transition duration-200 transform hover:scale-105">
